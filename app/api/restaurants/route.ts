...
const EXCLUDED = /파인다이닝|다이닝|와인바|와인 바|루프탑바|스카이라운지|호텔 레스토랑|오마카세|뷔페|칵테일|위스키|양조장|브루어리|펍|클럽|라운지바|술집|호프|포장마차|이자카야|주점|주막|생맥주|맥주집|하이볼|소주바|요리주점|치킨호프|노래방|가라오케|짐|양꼬치/i;
